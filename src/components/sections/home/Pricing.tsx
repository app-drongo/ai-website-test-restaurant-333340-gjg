...
const DEFAULT_PRICING = {
  ...
  mainDescription:
    'Choose from our carefully curated dining experiences. Each package includes appetizer, main course, and dessert with wine pairings available.',
  billingMonthly: 'À la Carte',
  billingAnnual: 'Prix Fixe',
  billingAnnualBadge: 'Best Value',
  plan1Name: 'Lunch Special',
  plan1Description: 'Perfect for a quick business lunch or casual dining',
  plan1Price: '$28',
  plan1CTA: 'Reserve Table',
  plan1CTAHref: '/reservations',
  plan2Name: "Chef's Selection",
  plan2Description: 'Our most popular multi-course dining experience',
  plan2Price: '$65',
  plan2Period: '/person',
  plan2Badge: 'Most Popular',
  plan2CTA: 'Book Experience',
  plan2CTAHref: '/reservations',
  plan2Trial: 'Wine pairing available • Dietary restrictions accommodated',
  plan3Name: 'Private Dining',
  plan3Description: 'Exclusive experience for special occasions and groups',
  plan3Price: 'Custom',
  plan3Badge: 'Contact Us',
  plan3CTA: 'Plan Event',
  plan3CTAHref: '/contact',
  bottomTitle: 'Planning a special celebration?',
  bottomDescription:
    'We offer customized menus and private dining experiences for weddings, corporate events, and special occasions. Let our culinary team create an unforgettable experience.',
  bottomCTA: 'Discuss Your Event',
