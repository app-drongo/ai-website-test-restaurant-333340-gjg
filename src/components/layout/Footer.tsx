...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Experience authentic Italian cuisine crafted with the finest ingredients and traditional recipes passed down through generations. Join us for an unforgettable dining experience in the heart of the city.',
